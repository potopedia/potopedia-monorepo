...
export function RegisterModal({ isOpen, onClose, onOpenLogin, defaultUserType = "photographer" }: RegisterModalProps) {
  ...
  useEffect(() => {
    if (
      defaultUserType &&
      (defaultUserType === "photographer" || defaultUserType === "client" || defaultUserType === "guest")
    ) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="text-center text-xs text-muted-foreground mt-2">
          ...
          <Button variant="link" className="p-0 h-auto text-xs" onClick={handleLoginClick}>
            Sign in
          </Button>
        </div>
      </DialogContent>
