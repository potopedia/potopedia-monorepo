...
export default function RegisterPage() {
  ...
  const [userType, setUserType] = useState<'photographer' | 'client' | 'guest'>("photographer")
  ...
  useEffect(() => {
    if (typeParam && (typeParam === "photographer" || typeParam === "client" || typeParam === "guest")) {
      setUserType(typeParam as 'photographer' | 'client' | 'guest')
    }
  }, [typeParam])
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-muted/30">
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <Tabs value={userType} onValueChange={(value) => setUserType(value as 'photographer' | 'client' | 'guest')}>
